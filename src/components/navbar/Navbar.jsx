                    ...
                    <Toolbar sx={{
                        ...
                        <Box>
                            ...
                            {user.isAuthenticated ? (
                                <>
                                    <Button onClick={() => navigate('/user')} color="inherit" sx={{ color: "#343434" }}>
                                        {user.user.name}
                                    </Button>
                                    <IconButton
                                        size="large"
